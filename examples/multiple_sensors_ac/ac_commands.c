...
static int16_t Fan[] = {9016 ,-4462 ,  680 ,-1628 ,  681 ,-1627 ,  681 , -551 ,  656 ,-1626 ,  682 , -551 ,  656 , -550 ,  657 , -550 ,
...
static int16_t Cool_16[] = {9013 ,-4467 ,  680 ,-1629 ,  682 , -525 ,  683 , -523 ,  674 ,-1633 ,  678 ,-1630 ,  681 ,-1627 ,  684 , -522 ,
...
static int16_t Cool_17[] = {9050 ,-4429 ,  706 ,-1602 ,  708 , -499 ,  709 , -497 ,  711 ,-15 ,  704 ,-1604 ,  706 , -500 ,
...
static int16_t Cool_19[] = {9046 ,-4459 ,  675 ,-1633 ,  676 , -557 ,  650 , -556 ,  652 ,-1629 ,  680 ,-1627 ,  683 , -550 ,  657 , -523 ,
...
static int16_t Cool_20[] = {9018 ,-4461 ,  682 ,-1626 ,  684 , -549 ,  647 , -559 ,  649 ,-1632 ,  677 ,-1630 ,  680 , -553 ,  654 , -553 ,
...
static int16_t Cool_21[] = {9042 ,-4464 ,  680 ,-1627 ,  683 , -551 ,  656 , -523 ,  674 ,-1633 ,  676 ,-1631 ,  679 , -554 ,  653 , -554 ,
...
static int16_t Cool_22[] = {9024 ,-4456 ,  678 ,-1629 ,  680 , -553 ,  654 , -552 ,  656 ,-1625 ,  684 ,-1625 ,  674 , -558 ,  649 , -557 ,
...
static int16_t Cool_23[] = {9020 ,-4459 ,  674 ,-1633 ,  677 , -557 ,  650 , -556 ,  651 ,-1630 ,  679 ,-1629 ,  681 , -552 ,  655 , -551 ,
...
static int16_t Cool_24[] = {9020 ,-4458 ,  675 ,-1633 ,  677 , -556 ,  651 , -556 ,  651 ,-1629 ,  681 ,-1627 ,  682 , -551 ,  656 , -550 ,
...
static int16_t Cool_25[] = {9020 ,-4461 ,  683 ,-1625 ,  674 , -559 ,  648 , -558 ,  649 ,-1633 ,  677 ,-1630 ,  679 , -553 ,  654 , -553 ,
...
static int16_t Cool_26[] = {9017 ,-4462 ,  681 ,-1627 ,  682 , -551 ,  657 , -549 ,  647 ,-1634 ,  676 ,-1632 ,  677 , -555 ,  652 , -555 ,
...
static int16_t Cool_27[] = {9021 ,-4457 ,  677 ,-1629 ,  680 , -554 ,  653 , -553 ,  654 ,-1627 ,  682 ,-1625 ,  674 , -561 ,  647 , -557 ,
...
static int16_t Cool_28[] = {9013 ,-4465 ,  678 ,-1630 ,  680 , -554 ,  653 , -553 ,  654 ,-1627 ,  683 ,-1625 ,  674 , -558 ,  649 , -558 ,
...
static int16_t Cool_29[] = {9014 ,-4465 ,  678 ,-1629 ,  681 , -552 ,  655 , -551 ,  656 ,-1625 ,  674 ,-1633 ,  676 , -557 ,  651 , -555 ,
...
static int16_t Cool_30[] = {9020 ,-4459 ,  674 ,-1633 ,  677 , -556 ,  651 , -555 ,  652 ,-1629 ,  680 ,-1628 ,  682 , -551 ,  656 , -551 ,
...
static int16_t Heat_16[] = {9044 ,-4461 ,  675 , -557 ,  651 , -556 ,  651 ,-1657 ,  654 ,-1654 ,  656 ,-1651 ,  649 , -558 ,  650 , -556 ,
...
static int16_t Heat_17[] = {9046 ,-4460 ,  675 , -557 ,  651 , -530 ,  678 ,-1655 ,  656 ,-1625 ,  675 ,-1634 ,  676 , -531 ,  677 , -556 ,
...
static int16_t Heat_18[] = {9046 ,-4459 ,  677 , -555 ,  653 , -554 ,  654 ,-1654 ,  656 ,-1626 ,  675 ,-1659 ,  651 , -530 ,  678 , -554 ,
...
static int16_t Heat_19[] = {9024 ,-4456 ,  679 , -554 ,  654 , -553 ,  655 ,-1625 ,  676 ,-1659 ,  651 ,-1630 ,  680 , -552 ,  656 , -551 ,
...
static int16_t Heat_20[] = {9045 ,-4458 ,  677 , -529 ,  679 , -554 ,  654 ,-1653 ,  648 ,-1660 ,  650 ,-1657 ,  654 , -553 ,  655 , -551 ,
...
static int16_t Heat_21[] = {9043 ,-4463 ,  683 , -523 ,  674 , -533 ,  675 ,-1632 ,  679 ,-1656 ,  654 ,-1626 ,  675 , -532 ,  675 , -531 ,
...
static int16_t Heat_22[] = {9013 ,-4467 ,  679 , -553 ,  655 , -552 ,  656 ,-1625 ,  675 ,-1632 ,  679 ,-1629 ,  682 , -524 ,  684 , -549 ,
...
static int16_t Heat_23[] = {9040 ,-4464 ,  682 , -551 ,  657 , -549 ,  649 ,-1632 ,  679 ,-1655 ,  655 ,-1627 ,  674 , -532 ,  676 , -557 ,
...
static int16_t Heat_24[] = {9016 ,-4464 ,  682 , -551 ,  657 , -550 ,  648 ,-1633 ,  677 ,-1630 ,  681 ,-1627 ,  683 , -550 ,  648 , -559 ,
...
static int16_t Heat_25[] = {9043 ,-4460 ,  683 , -551 ,  646 , -559 ,  650 ,-1658 ,  652 ,-1629 ,  682 , -551 ,  657 ,-1650 ,  650 , -557 ,
...
static int16_t Heat_26[] = {9012 ,-4467 ,  680 , -553 ,  655 , -552 ,  656 ,-1625 ,  675 ,-1660 ,  651 , -556 ,  652 ,-1629 ,  682 , -551 ,
...
static int16_t Heat_27[] = {9048 ,-4459 ,  677 , -556 ,  652 , -554 ,  654 ,-1627 ,  673 ,-1634 ,  677 , -557 ,  651 ,-1656 ,  655 , -552 ,
...
static int16_t Heat_28[] = {9047 ,-4459 ,  677 , -555 ,  653 , -554 ,  654 ,-1627 ,  684 ,-1624 ,  676 ,-1632 ,  679 ,-1629 ,  681 , -552 ,
...
static int16_t Heat_29[] = {9044 ,-4462 ,  674 , -559 ,  649 , -557 ,  651 ,-1630 ,  681 ,-1627 ,  684 ,-1624 ,  676 ,-1631 ,  680 , -553 ,
...
static int16_t Heat_30[] = {9019 ,-4461 ,  675 , -558 ,  650 , -557 ,  651 ,-1656 ,  655 ,-1626 ,  675 ,-1633 ,  678 ,-1630 ,  681 , -552 ,
...
void ac_button_cool_30(){
	...
	ir_tx_init();
	ir_raw_send(Cool_30, sizeof(Cool_30) / sizeof(*Cool_30));
...
void ac_button_cool_29(){
	...
	ir_tx_init();
	ir_raw_send(Cool_29, sizeof(Cool_29) / sizeof(*Cool_29));
...
void ac_button_cool_28(){
	...
	ir_tx_init();
	ir_raw_send(Cool_28, sizeof(Cool_28) / sizeof(*Cool_28));
...
void ac_button_cool_27(){
	...
	ir_tx_init();
	ir_raw_send(Cool_27, sizeof(Cool_27) / sizeof(*Cool_27));
...
void ac_button_cool_26(){
	...
	ir_tx_init();
	ir_raw_send(Cool_26, sizeof(Cool_26) / sizeof(*Cool_26));
...
void ac_button_cool_25(){
	...
	ir_tx_init();
	ir_raw_send(Cool_25, sizeof(Cool_25) / sizeof(*Cool_25));
...
void ac_button_cool_24(){
	...
	ir_tx_init();
	ir_raw_send(Cool_24, sizeof(Cool_24) / sizeof(*Cool_24));
...
void ac_button_cool_23(){
	...
	ir_tx_init();
	ir_raw_send(Cool_23, sizeof(Cool_23) / sizeof(*Cool_23));
...
void ac_button_cool_22(){
	...
	ir_tx_init();
	ir_raw_send(Cool_22, sizeof(Cool_22) / sizeof(*Cool_22));
...
void ac_button_cool_21(){
	...
	ir_tx_init();
	ir_raw_send(Cool_21, sizeof(Cool_21) / sizeof(*Cool_21));
...
void ac_button_cool_20(){
	...
	ir_tx_init();
	ir_raw_send(Cool_20, sizeof(Cool_20) / sizeof(*Cool_20));
...
void ac_button_cool_19(){
	...
	ir_tx_init();
	ir_raw_send(Cool_19, sizeof(Cool_19) / sizeof(*Cool_19));
...
void ac_button_cool_18(){
	...
	ir_tx_init();
	ir_raw_send(Cool_18, sizeof(Cool_18) / sizeof(*Cool_18));

}


void ac_button_cool_17(){

	ir_tx_init();
	ir_raw_send(Cool_17, sizeof(Cool_17) / sizeof(*Cool_17));

}

void ac_button_cool_16(){

	ir_tx_init();
	ir_raw_send(Cool_16, sizeof(Cool_16) / sizeof(*Cool_16));
...
ir_tx_init();
	ir_raw_send(Heat_16, sizeof(Heat_16) / sizeof(*Heat_16));
...
ir_tx_init();
	ir_raw_send(Heat_17, sizeof(Heat_17) / sizeof(*Heat_17));
...
ir_tx_init();
	ir_raw_send(Heat_18, sizeof(Heat_18) / sizeof(*Heat_18));
...
ir_tx_init();
	ir_raw_send(Heat_19, sizeof(Heat_19) / sizeof(*Heat_19));
...
ir_tx_init();
	ir_raw_send(Heat_20, sizeof(Heat_20) / sizeof(*Heat_20));
...
ir_tx_init();
	ir_raw_send(Heat_21, sizeof(Heat_21) / sizeof(*Heat_21));
...
ir_tx_init();
	ir_raw_send(Heat_22, sizeof(Heat_22) / sizeof(*Heat_22));
...
ir_tx_init();
	ir_raw_send(Heat_23, sizeof(Heat_23) / sizeof(*Heat_23));
...
ir_tx_init();
	ir_raw_send(Heat_24, sizeof(Heat_24) / sizeof(*Heat_24));
...
ir_tx_init();
	ir_raw_send(Heat_25, sizeof(Heat_25) / sizeof(*Heat_25));
...
ir_tx_init();
	ir_raw_send(Heat_26, sizeof(Heat_27) / sizeof(*Heat_28));
...
ir_tx_init();
	ir_raw_send(Heat_27, sizeof(Heat_27) / sizeof(*Heat_27));
...
ir_tx_init();
	ir_raw_send(Heat_28, sizeof(Heat_28) / sizeof(*Heat_28));
...
ir_tx_init();
	ir_raw_send(Heat_29, sizeof(Heat_29) / sizeof(*Heat_29));
}

void ac_button_heat_30(){
ir_tx_init();
	ir_raw_send(Heat_30, sizeof(Heat_30) / sizeof(*Heat_30));
